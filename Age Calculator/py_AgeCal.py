...
label_showAge = Label(window,text='',bg='MediumOrchid1',fg='DarkOrchid4',width = 20,justify='left')
...
def cal_age():
    try:
        ...
        if year > date.today().year or year <= 0 or len(str(year)) != 4:
            ...
            if year == today_year and month > today_month or year == today_year and day > today_day:
...
# buttons
button_getage = Button(window,text='Age',command=cal_age,height = 1, width = 8,borderwidth=5)
button_getage.configure(fg='Black',bg='DarkOrchid2',font=('bold'))
button_getage.place(x='200',y='370')

button_add = Button(window,text='Add',command=add,height = 1, width = 8,borderwidth=5)
button_add.configure(fg='Black',bg='DarkOrchid2',font=('bold'))
button_add.place(x='625',y='370')

button_clear = Button(window,text='Clear',command=clear,height = 1, width = 8,borderwidth=5)
